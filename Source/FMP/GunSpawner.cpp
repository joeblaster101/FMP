...
void AGunSpawner::WeaponSpawn(const TArray<TSubclassOf<AActor>> Guns, const int32& CurrentLevel, const FVector& Location, const FRotator& Rotation)
{
	
	if (Guns.IsValidIndex(CurrentLevel))
	{
